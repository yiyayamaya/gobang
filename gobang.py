...
def goonce(self, chessboard):
    ...
    for i in range(15):
        for j in range(15):
            ...
            print(i,j)
            jugby5(i, j, chessboard,"heng",valueboard)
            jugby5(i, j, chessboard, "shu",valueboard)
            jugby5(i, j, chessboard, "xie",valueboard)
...
def jugby5(x,y,chessboard,mode,valueboard):
    ...
    if result in[[m,m,m,0,0],[0,m,m,m,0],[0,0,m,m,m]]:
        print("1的活三")
        print((x,y),"value加几")
    elif result in[[m,m,0,0,0],[0,m,m,0,0],[0,0,m,m,0],[0,0,0,m,m]]:
        print("1的活二")
        print((x, y), "value加几")
    elif result in[[m,0,m,m,0],[0,m,0,m,m]]:
        print("1的跳三")
        print((x, y), "value加几")
    elif result in[[m,m,0,m,0],[0,m,m,0,m]]:
        print("1的跳四")
        print((x, y), "value加几")
    elif result in[[m,m,0,m,m],[m,m,m,0,m],[m,0,m,m,m]]:
        print("1的跳五")
        print((x,y),"value加几")
    elif result in[[m,m,m,m,0],[0,m,m,0,0],[0,0,m,m,0],[0,0,0,m,m]]:
        print("1的眠四")
        print((x, y), "value加几")
